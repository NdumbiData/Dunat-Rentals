...
import { addCar } from '@/app/actions/fleet';
...
export default function AddCarModal({ isOpen, onClose, owners = [] }: { isOpen: boolean; onClose: () => void; owners?: { id: string; name: string; email?: string }[] }) {
    const { user } = useAuth();
    ...
    return (
        <div style={{
            ...
            <div className="card" style={{ width: '100%', maxWidth: '500px', position: 'relative', maxHeight: '90vh', overflowY: 'auto' }}>
                ...
                <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1.5rem' }}>Add New Car</h2>

                {showSuccess ? (
                    <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--success)' }}>
                        <p style={{ fontSize: '1.25rem', fontWeight: 'bold' }}>✓ Car Added Successfully!</p>
                    </div>
                ) : (
                    <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            <div>
                                ...
                                <input name="make" type="text" className="input" required placeholder="e.g. Toyota" />
                            ...
                            <div>
                                ...
                                <input name="model" type="text" className="input" required placeholder="e.g. Camry" />
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            <div>
                                ...
                                <input name="year" type="number" className="input" required min="1900" max={new Date().getFullYear() + 1} defaultValue={new Date().getFullYear()} />
                            ...
                            <div>
                                ...
                                <input name="plate" type="text" className="input" required placeholder="KAA 123A" />
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            ...
                            <div>
                                ...
                                <input name="dailyRate" type="number" className="input" required min="0" step="100" placeholder="5000" />
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: '0.25rem', fontSize: '0.875rem', fontWeight: '500' }}>Car Image</label>
